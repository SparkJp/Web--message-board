...
<body>
	...
	<div class="box" style="background-image: url('<%=basePath %>image/loginpage.png');background-size:100%;">
		<div class="login-box">
			<div class="login-title text-center">
				<h1><small>奇怪留言板</small></h1>
			</div>
			<div class="login-content ">
				<div class="form">
					<form id="loginform" action="myseverlet" method="post" accept-charset="UTF-8">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="registerform" action="myseverlet" method="post" accept-charset="UTF-8"
							...
							<div class="col-xs-12  ">
								<div class="input-group">
									...
									<input type="text" name="username" id="username" class="form-control"
										placeholder="用户名" maxlength="20" onfocus="$('#usernameInfo').show()"
						...
						<div class="form-group">
							<div class="col-xs-12  ">
								<div class="input-group">
									...
									<input type="text" name="sid" id="sid" class="form-control" placeholder="学号"
							...
							<div class="col-xs-12  ">
								<div class="input-group">
									...
									<input type="text" name="classname" id="classname" class="form-control"
										placeholder="班级" maxlength="100" onfocus="$('#classInfo').show()"
										onblur="$('#classInfo').hide()">
								</div>
							</div>
							<div class="well" id="classInfo" style="display: none;">
								提示:您的班级不能填错哦
							</div>
						</div>
						...
						<div class="form-group form-actions">
							<div class="col-xs-4 col-xs-offset-4 ">
								<button type="submit" class="btn btn-sm btn-info" onclick="subRegister()"><span
										class="glyphicon glyphicon-off"></span> 注册</button>
							</div>
						</div>
					</form>
				</div>
...
<!--
<body>
    <h1 align="center">奇怪的登录页面</h1>
    <form action="myseverlet" method="post" align="center">
    	<input type="hidden" name="action" value="login"/>
